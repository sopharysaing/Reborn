...
public class EditStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbSelectStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "   Status", "   Active", "   Inactive" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(cbSelectStatus, 0, 1, Short.MAX_VALUE))
                        .addGroup(layout.createSequentialGroup()
    ...
    private void getStaff(){
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM dbmajorcineplex.tblstaff WHERE StaffID = "+ListStaff.staffIDSelected+";");
            if (resultSet.first()){
                do {
                    txtName.setText(resultSet.getString(2));
                    txtTelephone.setText(resultSet.getString(6));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            if (!lbProfilePhoto.getIcon().equals(null)){
                if (!txtName.getText().equals("Full Name")){
                    if (genderDetector){
                        if (!txtTelephone.getText().equals("Telephone")){
                            if (!txtEmail.getText().equals("Email")){
                                if (!txtDateofBirth.getText().equals("Date of Birth")){
...
//        }
        ...
        cbSelectPosition.setSelectedItem("   Position");
        nameDetector = false;
        txtName.grabFocus();
