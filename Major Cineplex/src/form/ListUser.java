...
public class ListUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEditUser.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        ...
        btnEditUser.setPreferredSize(new java.awt.Dimension(150, 45));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Staff Name", "User Name", "Password", "Role"
            }
        ) {
    ...
    private void tableRow (){
        try {
            ...
            "FROM\n" +
            "tbluser\n" +
            "INNER JOIN tblstaff ON tbluser.StaffID = tblstaff.StaffID\n" +
    ...
    private void getStaffID(){
        try {
            ...
            if (resultSet.first()){
                do {
                    if (staffIDSelected.equals(resultSet.getString(2)))
                        staffIDSelected = resultSet.getString(1);
