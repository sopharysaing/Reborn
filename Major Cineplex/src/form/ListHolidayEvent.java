 ...
 * @author MacBookPro
 */
public class ListHolidayEvent extends javax.swing.JFrame {

    /**
     * Creates new form MovieList
     */
    public ListHolidayEvent() {
    ...
    private void initComponents() {
        ...
        btnCreateMovie1 = new javax.swing.JButton();
        ...
        btnCreateNew.setFont(new java.awt.Font("Calibri", 1, 15)); // NOI18N
        ...
        btnCreateMovie1.setFont(new java.awt.Font("Calibri", 1, 16)); // NOI18N
        btnCreateMovie1.setForeground(new java.awt.Color(51, 51, 51));
        btnCreateMovie1.setText("Edit");
        btnCreateMovie1.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btnCreateMovie1.setFocusable(false);
        btnCreateMovie1.setPreferredSize(new java.awt.Dimension(150, 45));
        btnCreateMovie1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCreateMovie1ActionPerformed(evt);
            }
        });
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Holiday ID", "Holiday Date", "Description"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(btnCreateMovie1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tableRow (){
        try {
            ...
            "tblholiday.HolidayID,\n" +
            "tblholiday.HolidayDate,\n" +
            "tblholiday.HolidayDescription\n" +
            "FROM\n" +
            "tblholiday");
            table.setRowCount(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListHolidayEvent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListHolidayEvent().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnCreateMovie1;
