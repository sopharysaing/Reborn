...
public class ListTicket extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEdit.setPreferredSize(new java.awt.Dimension(150, 45));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Invoice Date", "Movie Title", "Customer Name", "Book Code", "Seats", "Glasses", "Promotion", "Discount", "SubTotal"
            }
        ) {
    ...
    private void tableRow (){
        try {
            ...
            "tbltinvoice.TInvoiceID,\n" +
            "tbltinvoice.TInvoiceDate,\n" +
            "tblmovie.MovieTitle,\n" +
            "tblcustomer.CustomerName,\n" +
            "tblseat.SeatNum,\n" +
            "tblproduct.ProductName,\n" +
            "tblpromotion.PromotionName,\n" +
            "tbltinvoice.TDiscount,\n" +
            "tbltinvoice.SubTotal\n" +
            "FROM\n" +
            "tbltinvoice\n" +
            "INNER JOIN tblmovie ON tbltinvoice.MovieID = tblmovie.MovieID\n" +
            "INNER JOIN tblcustomer ON tbltinvoice.CustomerID = tblcustomer.CustomerID ,\n" +
            "tblseat ,\n" +
            "tblproduct ,\n" +
            "tblpromotion");
