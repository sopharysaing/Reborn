 ...
 * @author MacBookPro
 */
public class EditStaffConfirm extends javax.swing.JDialog {

    /**
     * Creates new form BooksPayment
     */
    public EditStaffConfirm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {Image image = ImageIO.read(getClass().getResource(EditStaff.profilePhotoPath));lbProfilePhoto.setIcon(new ImageIcon(image));lbProfilePhoto.setText("");}catch (Exception e){}
        nameLabel.setText(EditStaff.name);
        genderLabel.setText(EditStaff.gender);
        telephoneLabel.setText(EditStaff.telephone);
        emailLabel.setText(EditStaff.email);
        dobLabel.setText(EditStaff.dateofbirth);
        positionLabel.setText(EditStaff.position);
        statusLabel.setText(EditStaff.status);
        salaryLabel.setText(EditStaff.salary);
        txtAddress.setText(EditStaff.address);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStaffConfirm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                EditStaffConfirm dialog = new EditStaffConfirm(new javax.swing.JFrame(), true);
